...
const PokemonEvolution = () => {
  ...
  if(evolutionInfo.length <2){
    return (
      ...
      <div className="px-8  py-4 flex flex-col sm:flex-row md:gap-10 gap-4 items-center justify-center">
            ...
            return (
              <>
                <PokemonCard
                  ...
                  evolution="evolution"
                />
                {index != lastEvol && <GoTriangleRight className="text-[8rem] lg:rotate-0 rotate-90 text-[#485460]" />}
              </>
            );
          })}
        </div>
