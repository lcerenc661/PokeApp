      ...
      <div className="flex md:justify-between justify-center xl:px-32 lg:px-16 md:px-8">
        ...
        <div className="flex  gap-16  md:gap-8 text-xl text-[#485460]">
          <Link className={`flex items-center`} to="/">
            <button className={`${actualPage ==="home" ? "text-[#1e272e] font-bold text-2xl bg-[#ffffff50]": ""} transition-all px-3 py-1 rounded-2xl`}>Home</button>
          </Link>
          <Link className="flex items-center" to="/pokedex/pokemons">
            <button className={`${actualPage ==="pokedex" ? "text-[#1e272e] font-bold text-2xl bg-[#ffffff50]": ""} transition-all px-3 py-1 rounded-2xl`}>Pokedex</button>
          </Link>
          <Link className="flex items-center" to="/pokedex/pokemons">
